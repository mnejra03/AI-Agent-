...
# Tech Stack
LayerTechnologyFrontendHTML, CSS, JavaScriptBackendPython, Flask, Flask-CORSML Modelscikit-learn (Random Forest)StorageSQLiteAgentCustom Python agent (sense → think → act → learn)
